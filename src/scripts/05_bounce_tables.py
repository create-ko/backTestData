...
입력: ktr_takeprofit_N_all_tf_2010-01-01_2026-06-16.csv , sim_all_tf_2010-01-01_2026-06-16.csv
...
# ---------- 04: 반등/MFE ----------
tp = [r for r in load("ktr_takeprofit_N_all_tf_2010-01-01_2026-06-16.csv") if r["base종류"] == "KTR"]
...
# ---------- 03: 손절률 ----------
sim = [r for r in load("sim_all_tf_2010-01-01_2026-06-16.csv") if r["base종류"] == "KTR"]
